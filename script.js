/*
Pseudocode/Outline below, code for CYOA begins on line 56
RICK AND MORTY CYOA
...
-Wow, really? You picked the wrong conceptual horse, here. Ok, how many jobs can you help Jerry apply to?
  ...
  alert("Job application: "+i+" STATUS: DENIED")
}
...
var hang = prompt("Hello, "+userName+". Who would you like to hang with today? (R) Rick, (M) Morty, (J) Jerry").toUpperCase()
//var hang = hang1.toUpperCase()

//Code for Rick outcome below
if (hang == "R") {
    var rickChoice = prompt("It's a slow summer day, Rick wants to know if you want to help him (F) fix the spaceship battery or (B) spend the day gambling shmeckles at Blips and Chitz.").toUpperCase()
//Fix battery
    if (rickChoice == "F") {alert("You and rick are transported into the car battery microverse. A mad scientist in the battery microverse has invented a microverse to power his world. You enter the microverse's microverse... After countless Inception-style levels, you resolve the battery issue. Rick awards you 200 shmeckles.")
    }
//Blips and Chitz
        ...
        var roy = parseInt(roy1)
          if (roy===1989) {alert("You score high enough for first place! Everyone at Blips and Chitz loves you and you've earned Rick's respect. +1,000,000 Shmeckles.")}
          else if (roy <=1900) {alert("Life was tough back then. You score 89,687, good enough for 162nd place. Rick laughs at your poor performace.")}
          else if (roy >= 2000) {alert("Roy is born too late for your sensibilities, kids these days... Game over before you reach 8th grade. Rick tries to cheer you up with some ice cream.")}
          else if (1900 < roy < 1989) {alert("You score 249,976, good enough for 17th place! Rick scores higher... You had an ok day, I guess.")}
          else if (1989 < roy < 1999) {alert("You score 249,976, good enough for 17th place! Rick scores higher... You had an ok day, I guess.")}
    }
//Invalid Rick choice:
    else {alert("You have not selected a valid input... GAME OVER.")}
}

//Hang with Morty
else if (hang == "M") {
    var mortyChoice = prompt("It's Saturday after a long school week and Morty wants to unwind. How do Morty and "+userName+" unwind? (T) See if Rick wants to watch interdimensional cable, (M) waste time at the mall where Morty's friends are").toUpperCase()

//Watch TV
    if (mortyChoice == "T") {
        var tv = prompt("Rick: Score! What are we watching today? (T) Two Brothers: The Movie, (H) How They Do It, (G) Gazorpazorpfield").toUpperCase()
          //Two brothers the movie
          if (tv=="T") {alert("FINALLY RELEASED ON TV: Two brothers. In a van. And then a meteor hit. And they ran as fast as they could. From giant cat-monsters. And then a giant tornado came. And that's when things got knocked into twelfth gear...A Mexican...armada shows up. With weapons made from to- tomatoes. And you better betch'ur bottom dollar that these two brothers know how to handle business. In! 'Alien...Invasion Tomato Monster Mexican Armada Brothers...Who Are Just Regular Brothers Running...in a Van from an...Asteroid and All Sorts of Things: The Movie'. Hold on! There's more. Old women are comin'! And they're also in the movie and they're gonna come...and cross...attack...these two brothers. But let's get back to the brothers because they're- they have a strong bond! You don't wanna know about it here, but I'll tell you one thing. The Moon. It comes crashing into Earth! And whaddya do then? It's two brothers and I- and...and they're gonna...it's called 'Two Brothers' ...'Two Brothers'...it's just called 'Two Brothers'! " +userName+" had a chill day.")}
          //Plumbus
          else if (tv=="H") {alert("Today's episode, the plumbus. Rick always wanted to know how those were made. " +userName+" had a chill day.")}
          //Gazorpazorpfield
          else if (tv=="G") {alert("Morty: Jeez, Rick, Gazorpazorpfield sure was pissed off today. " +userName+" had a chill day.")}
        }
//go to Mall
    else if (mortyChoice == "M") {
            var rick = prompt("Rick storms in and says: THERE'S NO TIME FOR THAT RIGHT NOW MORTY & "+userName.toUpperCase()+"! YOU GOTTA HELP ME RIGHT NOW. (H) Help Rick, (D) Don't help").toUpperCase()
              //Help Rick
              if (rick == "H") {alert("You grab a screwdriver nearby and toss it to Rick. He quickly grabs an accelerator he has laying around to shoot the screwdriver at the giant floobiedip that was lunging. It dies! " +userName+" helped save the day!")}
              //Don't help Rick
              else {alert("Rick is left without help, Morty and "+userName+" never see Rick again. Game over.")}
        }
...
//Hang with Jerry, why would you do that?
    ...
    var jerry = parseInt(jerry1)
      for (var i = 1; i <= jerry; i++)
      {alert(userName + " helped Jerry apply to job "+i+". Status: DENIED.")}
}
