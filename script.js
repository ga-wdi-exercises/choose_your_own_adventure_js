...
//
// Special cases:
// If a node has less than three possible answers the address space
...
//
// Answers shouldn't ever have a capital letter in them, the code to parse user 
// text automatically makes the entered string lower case.  Because the same
// isn't done for the text within a node, the user would never be able to select
// an answer unless they specifically used the numbered answer select option.
var nodes=[["you are Sterling Archer, world's greatest spy.  you arrive at work, who do you speak with first?"                                                                    ,"llana"         ,1  ,"mallory"                     ,2   ,"find the others"                                     ,3],
           ...
           ["you walk over to the armory and mallory informs you of your next mission.  you grab a pistol and explain how you will handle it..."                                  ,"END"           ,-1 ,"END"                         ,-1  ,"https://www.youtube.com/watch?v=YhzIy-6lKyU#t=1m34s",-1],
