  ...
  buffer( )
    ...
    console.log("Samuel L. Jackson appears and says 'A penny saved is a penny earned mothafucka!'")
      var samResponse = prompt("The princess of Skeet-town has been kidnapped by an evil bridge troll. Will you save her? (Please enter 'Y' or 'N')")
        ...
        else if(samResponse == "Y"){ //Theres an issue here not sure why im getting syntax error//
        ...
        buffer( )
        var trollResponse= prompt("The troll jumps out and proposes a game... Do you /n('G') - play the game? /n('M') - Murder the troll? /n('S') - Smoke the pipe?")
          if(trollResponse == 'M'){
          ...
          else if(trollResponse == 'G'){
            console.log("something something hang on a sec")
          }
        }
