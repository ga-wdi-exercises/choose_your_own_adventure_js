...
buffer()
var pathInput = prompt("You can either take a Boat, a Plane, a Helicopter, or Swim..(please enter ('b' or 'p' or 'h' or 's')")
...
if(pathInput == "p"){
  console.log("You take a plane, but the ride is turbulent with a harsh landing rupturing one of your kidneys, you make it to the island but you’re in a lot of pain")
  buffer()

  if(pathInput == "h"){
    console.log("Helicopter: You get to the other side smoothly, except when landing you hit some trees and the left side of the helicopter slams into the ground crushing the pilot, who wasn’t buckled in, and breaking the three of the four blades.")

if(pathInput == "s"){
  console.log("You jump and befriend a seal — seal becomes your true lover and your life is complete...\n - your hunger for treasure diminishes")
}
