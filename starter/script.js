...
var name = prompt("what is your name?"); //.toUpperCase();
  if (name !=null); {
  document.write = ("Welcome" + name +", Congratulations on your new job as a web developer intern. Your annual salary is $35,000 per year. I'm here to help you find an apartment.")
  }
};
var choice = prompt("What part of the city would you like to live?NW, SW, NE, SE").toString();.toUpperCase(); {// change input to string and uppercase
  ...
  document.write("Northwest has great bars, resturants and tons of night life. \
  ...
  $,2000 per month in rent on your miserable intern salary \
    ...
    var roomMateOrUber = prompt("type R for roommates or U for Uber").toUpperCase();{ // find a way to restrict input to either of the two answers only
      if (roomMateOrUber == "R");{
      document.write("So you miss your college days, dorm rooms, roommates, and drama?\
       ...
       her job and can't make the rent.")
        ...
        Type 'K' to Kick her out or 'A' for AirBnB").toUpperCase(); { // make user choose btw Kick friend out or AirBnB
          ...
          document.write("Reasonable choice. Everyone needs to pay their own way, \
           who cares if you loose your best friend from 5th grade in the process. \
            ...
            document.write("AirBnB is a great way to cover your missing rent and help if he \
            ...
            document.write("Please type either R or U"); // force user to make a choice by repeating KickOrAirbnb
            return KickOrAirbnb;
          }
        }
      };
    else if (roomMateOrUber == "U") { // display if user chooses to do Uber
      document.write("Uber is great way to make money on your time with your car. \
      Uber black pays more but uber x has fewer rules.");
        ...
        var UberXOrBlack = prompt("Do you decide on uber X or uber black? Type'X' for UberX or 'B' for Uber-Black").toString();.toUpperCase(); { // decide if I want to keep using tostring or restrict user answer to only the 2 options
          if (UberXOrBlack == "X"); {
            document.write("on uber x you must work 5 hours a day 7 days a week to come up with the rent. \
            ...
            document.write("Uber black pays 3 times $40 per hour and you only have to work 15 hours a month to cover your rent. \
    ...
    document.write("Very Resonable choice. In fact it is so reasonable that 50,000 people just like you made the same choice \
    ...
    document.write("Northeast is a wise choice. Lots of up and coming nieghborhoods and your new place is in walking distance to your internship. \
    You no longer use your car on a regular basis.  Do you sell your car or keep it?");
      ...
      var sellOrKeep = prompt("Do you sell or keep your car? Type 'S' to sell it or 'K' to keep it");{
        if (sellOrKeep == "S"); {
          document.write("You sell your car and use the money to buy a new matching set of apple products; \
          Macbook, Ipad, and Iphone now you can code in style!")
        };
        else if (sellOrKeep == "K") {
          document.write("Hey you never know when you might need a car.  You use it for random roadtrips and as a backup when you need to go shopping. \
    ...
    document.write("Anacostia is one of the last places you can still get a one bedroom for less than $1000 per month. \
    You find the deal of a life time for $875 per month. The last decision you need to make is which apartment level you want.");
      ...
      var apartmentLevel = prompt("Do you want the top floor or the basement? Type'T' for top floor or 'B' for Basement)").toUpperCase();
        ...
        if (apartmentLevel = "T"); {
        document.write("Choosing the top floor guarantees no one will be stomping above your head. \
        ...
        On the bright side at least you don't have to pay for a gym membership with all those stairs.")
          ...
          document.write("The basement seems like a great choice, its cool in the summer time and easy access to bring things in and out your apartment. \
