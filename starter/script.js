...
var firstRound = function() {
  ...
  buffer();
  console.log("Please enter '1' to work on your novel, '2' to go see Danny, or '3' to ride the big wheel.")
  buffer();
  var firstInput = prompt("Please enter either \n'1': to work on your novel,\n'2': to go see Danny,\n'3': to ride the big wheel.");
...
var secondRound = function() {
  ...
  buffer();
  console.log("Please enter 'sabatoge' 'boardgames' or 'wendy darling'")
  buffer();
...
var thirdRound = function() {
  ...
  buffer();
  console.log("Please enter either 'gold', 'maze', or '237'")
  buffer();
